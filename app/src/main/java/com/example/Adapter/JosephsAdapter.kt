...
class JosephsAdapter( var context:Context) : RecyclerView.Adapter<JosephsAdapter.MyViewHolder>() {

    var color_icon_matrix = arrayOf <IntArray>(
        intArrayOf(android.R.color.holo_red_dark, R.drawable.st_josephs),
        intArrayOf (android.R.color.holo_blue_dark, R.drawable.stjosephs2),
        intArrayOf(android.R.color.holo_green_dark, R.drawable.stjosephs3),
        intArrayOf(android.R.color.holo_orange_dark, R.drawable.stjosephs4)
    )
