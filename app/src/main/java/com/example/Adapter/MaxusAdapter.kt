...
class MaxusAdapter( var context:Context) : RecyclerView.Adapter<MaxusAdapter.MyViewHolder>() {

    var color_icon_matrix = arrayOf <IntArray>(
        intArrayOf(android.R.color.holo_red_dark, R.drawable.maxus1),
        intArrayOf (android.R.color.holo_blue_dark, R.drawable.maxus2),
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        init{
            ...
            container = itemView.findViewById(R.id.maxus_container) as RelativeLayout
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(LayoutInflater.from(context).inflate(layout.maxus_layout_page,parent,false))
    }
