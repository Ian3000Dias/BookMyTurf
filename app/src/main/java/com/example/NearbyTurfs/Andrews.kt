...
import com.example.Adapter.AndrewsAdapter
...
class Andrews : AppCompatActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
...
//    var myMinute: Int = 0
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //map
        btn_map1.setOnClickListener {
            val url = "https://goo.gl/maps/xmAjRcotPYrxuw6d7"
    ...
    private fun init(){
        ...
        view_pager1.adapter = AndrewsAdapter(context = this)
    }
}
