...
import com.example.andrew.Adapter.GoldsAdapter
import com.example.splashscreen.R
//import kotlinx.android.synthetic.main.andrews.*
//import kotlinx.android.synthetic.main.andrews.book_btn
//import kotlinx.android.synthetic.main.golds.*
//import kotlinx.android.synthetic.main.sporting.*
import java.util.*

class Golds :AppCompatActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
...
//    var myMinute: Int = 0
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_map2.setOnClickListener {
            val url = "https://goo.gl/maps/Hn2c1UBijMbN8ziaA"
    ...
    private fun init(){
        ...
        view_pager2.adapter = GoldsAdapter(this)
    }
