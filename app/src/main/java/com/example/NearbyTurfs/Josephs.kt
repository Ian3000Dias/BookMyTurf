...
import com.example.Adapter.JosephsAdapter
import com.example.Adapter.SportingAdapter
...
//import kotlinx.android.synthetic.main.josephs.*
//import kotlinx.android.synthetic.main.sporting.*
import java.util.*

class Josephs : AppCompatActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
...
//    var myMinute: Int = 0
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.josephs)
        val book_btn = findViewById<Button>(R.id.book_btn)
        val btn_map3 = findViewById<Button>(R.id.btn_map3)
        //payment gateway
        book_btn.setOnClickListener {
            val intent = Intent(this,PaymentGateway1::class.java)
            intent.putExtra("Turf_Name","Josephs Turf",)
            intent.putExtra("Date_Time",time)
            intent.putExtra("Price","1500")
            startActivity(intent)
        }
        //map
        btn_map3.setOnClickListener {
            val url = "https://goo.gl/maps/TMxgKWtSPycvQjzZ9"
    ...
    private fun init(){
        ...
        view_pager3.adapter = JosephsAdapter(this)
    }
