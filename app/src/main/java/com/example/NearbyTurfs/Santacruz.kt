...
class Santacruz : AppCompatActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
...
//    var myMinute: Int = 0
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.santacruz)
       //payment gateway
    val book_btn = findViewById<Button>(R.id.book_btn)
    val btn_map4 = findViewById<Button>(R.id.btn_map4)
        book_btn.setOnClickListener {
            val intent = Intent(this,PaymentGateway1::class.java)
            intent.putExtra("Turf_Name","Santacruz Turf")
            intent.putExtra("Date_Time",time)
            intent.putExtra("Price","1500")
            startActivity(intent)
        }
        //map
        btn_map4.setOnClickListener {
            val url = "https://goo.gl/maps/2Sufm1TPSDcQEBh68"
    ...
    private fun init(){
        ...
        view_pager4.adapter = SantacruzAdapter(this)
    }
