...
class Sporting : AppCompatActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
...
//    var myMinute: Int = 0
    ...
    val btn_map5 = findViewById<Button>(R.id.btn_map5)
        book_btn.setOnClickListener {
            val intent = Intent(this,PaymentGateway1::class.java)
            intent.putExtra("Turf_Name","Sporting",)
            intent.putExtra("Date_Time",time)
            intent.putExtra("Price","1500")
            startActivity(intent)
        }
        //map
        btn_map5.setOnClickListener {
            val url = "https://g.page/Sportinglionsminiturf?share"
    ...
    private fun init(){
        ...
        view_pager.adapter = SportingAdapter(this)
    }
