...
import com.example.Adapter.StXaviersAdapter
import com.example.PaymentGateway1
import com.example.splashscreen.R
//import kotlinx.android.synthetic.main.pgvora.*
//import kotlinx.android.synthetic.main.stxaviers.*
//import kotlinx.android.synthetic.main.stxaviers.book_btn

import java.util.*

class StXaviers : AppCompatActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    lateinit var textView: TextView
    lateinit var button: Button
    lateinit var turfname : TextView
...
//    var myMinute: Int = 0
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.stxaviers)

        //payment gateway
        val book_btn = findViewById<Button>(R.id.book_btn)
        val btn_map8 = findViewById<Button>(R.id.btn_map8)
        book_btn.setOnClickListener {
//            val intent = Intent(this, PaymentGateway1::class.java)
//            startActivity(intent)
            val intent = Intent(this,PaymentGateway1::class.java)
            intent.putExtra("Turf_Name","StXaviers",)
            intent.putExtra("Date_Time",time)
            intent.putExtra("Price","1500")
            startActivity(intent)
        }

        btn_map8.setOnClickListener {
            val url = "https://goo.gl/maps/1F21o2dMQK5kGGYz5"
    ...
    private fun init(){
        ...
        view_pager5.adapter = StXaviersAdapter(this)
    }
}
